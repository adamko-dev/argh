...
internal class UploadReleaseDependencies internal constructor(
  project: Project,
) {
  private val objects: ObjectFactory = project.objects

  private val dependenciesContainer: NamedDomainObjectProvider<DependencyScopeConfiguration> =
    project.configurations.dependencyScope("githubAssetPublishUploaderClasspath") { c ->
      c.description = "The classpath used to prepare GitHub Release Assets."
      c.defaultDependencies { dependencies ->
        dependencies.add(project.dependencies.create(BuildConstants.libAssetUploaderCoords))
      }
    }
